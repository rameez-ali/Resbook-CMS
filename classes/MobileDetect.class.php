...
class MobileDetect
{
     ...
     */
    final public const DETECTION_TYPE_MOBILE     = 'mobile';
     ...
     * @deprecated since version 2.6.9
     */
    final public const DETECTION_TYPE_EXTENDED   = 'extended';
     ...
     * @deprecated since version 2.6.9
     */
    final public const VER                       = '([\w._\+]+)';

    /**
     * Top-level device.
     */
    final public const MOBILE_GRADE_A            = 'A';

    /**
     * Mid-level device.
     */
    final public const MOBILE_GRADE_B            = 'B';

    /**
     * Low-level device.
     */
    final public const MOBILE_GRADE_C            = 'C';

    /**
     * Stores the version number of the current release.
     */
    final public const VERSION                   = '2.8.26';

    /**
     * A type for the version() method indicating a string return value.
     */
    final public const VERSION_TYPE_STRING       = 'text';

    /**
     * A type for the version() method indicating a float return value.
     */
    final public const VERSION_TYPE_FLOAT        = 'float';
    ...
    public function setHttpHeaders($httpHeaders = null)
    {
        ...
        if (!is_array($httpHeaders) || $httpHeaders === []) {
            $httpHeaders = $_SERVER;
        }
     ...
     */
    public function getHttpHeader($header): ?string
    {
    ...
    public function setCfHeaders($cfHeaders = null) {
        ...
        if (!is_array($cfHeaders) || $cfHeaders === []) {
            $cfHeaders = $_SERVER;
        }
            ...
            if (isset($this->httpHeaders[$mobileHeader])) {
                if (is_array($matchType['matches'])) {
                    foreach ($matchType['matches'] as $_match) {
                        if (str_contains((string) $this->httpHeaders[$mobileHeader], (string) $_match)) {
                            return true;
                        }
                    }
     ...
     */
    public function is($key, $userAgent = null, $httpHeaders = null): bool|int|null
    {
    ...
    {
        $match = (bool) preg_match(sprintf('#%s#is', $regex), (empty($userAgent) ? $this->userAgent : $userAgent), $matches);
     ...
     */
    public function version($propertyName, $type = self::VERSION_TYPE_STRING): string|float
    {
        ...
        if (isset($properties[$propertyName])) {
            ...
            foreach ($properties[$propertyName] as $propertyMatchString) {
                ...
                $propertyPattern = str_replace('[VER]', self::VER, (string) $propertyMatchString);
