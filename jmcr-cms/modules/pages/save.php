...
function saveItem()
{
  ...
  $arrMetaData['video_thumbnail'] = validateInput('video_thumbnail');
  $arrMetaData['video_rank'] = (int) validateInput('video_module_rank');

  $arrMetaData['faqs_heading'] = validateInput('faqs_heading');
  $arrMetaData['faqs_rank'] = (int) validateInput('faqs_module_rank');
  $faqsPosts = requestVar('faqs');
  $arrMetaData['faqs_content'] = (!empty($faqsPosts)) ? json_encode(array_values($faqsPosts)) : '';
