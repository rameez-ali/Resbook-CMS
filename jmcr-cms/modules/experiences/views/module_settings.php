...
$tabModuleSettingsContent = '<table width="100%" border="0" cellspacing="0" cellpadding="8"> 
    <tr>
      <td colspan="2">
        <h2 class="form-section-heading">Featured Experiences</h2>
      </td>
    </tr>     
    <tr>
      <td width="200">
...
$tabModuleExperinceContent ='<table width="100%" border="0" cellspacing="0" cellpadding="8">
<tr>
  <td colspan="2">
    <h1 class="form-section-heading">Explore Other Experiences on Detail Page</h1>
  </td>
</tr>     
<tr>
  <td width="200">
    <label for="mod_experince_heading">Heading:</label>
  </td>
  <td>
    <input type="text" name="mod_experince_heading" id="mod_experince_heading" value="'.$eExperinceHeading.'" style="width:300px;" />
  </td>
</tr>
</table>';
?>