...
function editSettings() 
{
  ...
  if (!empty($itemSettings)) {
    ...
    $eHeading          = $itemSettings['heading'];
    $eExperinceHeading = $itemSettings['experince_heading'];
    $eButtonText       = $itemSettings['button_text'];
    $eDescription      = $itemSettings['description'];
    $eImpPage          = $itemSettings['imp_page'];
  ...
  $arrMenuTabs['Featured Experiences'] = $tabModuleSettingsContent;
  $arrMenuTabs['Explore Other Experiences']  = $tabModuleExperinceContent;
