...
function initMain()
{
  ...
  $moduleMainHeading  = 'Partnership Logos';
  $modMsgLabel        = 'Partnership Logo';
  ...
  switch ($action) {
    case 'publish':
      $message = ModuleAction::publish($itemSelect,'partnership_logo');
      break;

    case 'hide':
      $message = ModuleAction::hide($itemSelect,'partnership_logo');
      break;

    case 'delete':
      $message = ModuleAction::delete($itemSelect,'partnership_logo');
      break;

    case 'saverank':
      $message = ModuleAction::saveRank($itemRank,'partnership_logo');
      break;

    case 'trash': 
      $listType = FLAG_DELETED;
      $message = ($initRestore) ? ModuleAction::restore($itemSelect,'partnership_logo') : '';      
      break;
