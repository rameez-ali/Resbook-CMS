<?php
/**
 * Manage Google Map Account Details
 *
 * @category   Module
...
function initMain()
{
  ...
  $moduleMainHeading  = 'Google Map API Details';
  ...
  switch ($action) {
    ...
    case 'save-location':
      require_once __DIR__ . '/save_location.php';
      saveLocation();
      break;
  ...
  $moduleActions = '<ul class="page-action">
      ...
      <li>
        <button type="button" class="btn btn-default" onclick="submitForm(\'edit-location\')">
          <i class="fa fa-map-marker"></i> Location Map
        </button>
      </li>
      <li>
