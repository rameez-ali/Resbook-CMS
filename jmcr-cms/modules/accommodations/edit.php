...
function editItem()
{
  ...
  if (!empty($itemData)) {
    ...
    $itemAmenities = $itemData['amenities'];
    $itemServices = $itemData['services'];
  ...
  /** Product category tab content */
  require_once MOD_VIEWS_DIR . DS . 'amenities.php';

  /** Product category tab content */
  require_once MOD_VIEWS_DIR . DS . 'services.php';
  ...
  $arrMenuTabs['Amenities'] = $tabAmenitiesContent;
  $arrMenuTabs['Services'] = $tabServicesContent;
