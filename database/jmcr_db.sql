...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2026 at 11:57 PM
...
CREATE TABLE `accommodation` (
  ...
  `deck_size` varchar(255) DEFAULT NULL,
  `bedroom_details` varchar(255) DEFAULT NULL,
  `sleeps_details` varchar(255) DEFAULT NULL,
...
INSERT INTO `accommodation` (`id`, `guests`, `beds`, `bathrooms`, `room_size`, `from_price`, `currency_code`, `is_featured`, `from_price_caption`, `features`, `booking_url`, `button_text`, `page_meta_data_id`, `room_resbook_id`, `show_poa`, `amenities`, `services`, `type`, `deck_size`, `bedroom_details`, `sleeps_details`, `floor_plan`) VALUES
(1, 4, 2, 2, 44, 510.00, 'NZD', 'Y', 'Per night', '<ul><li>Mountain views</li><li>Super king bed</li><li>Fine natural-fiber linens and towels</li><li>Tea and coffee facilities</li><li>Heated floors</li><li>Walk-in rain showers</li><li>Free toiletries</li><li>Local NZ artworks</li><li>Keycard entry and locking</li><li>Blinds and shutters</li><li>Desk and chair</li><li>Luggage rack</li><li>Wardrobe</li><li>Free wifi</li><li>Free car parking</li><li>BBQ facilities</li></ul>', 'https://stleonards.thebookingengine.net/room-booking/346?/adult=2&amp;child=0&amp;apiKey=413hngqsddwh55njwd9h0ke3wj&amp;', NULL, 14, NULL, 'N', NULL, NULL, NULL, '31', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', NULL),
(2, 3, 1, 1, 42, NULL, NULL, 'Y', NULL, NULL, NULL, 'Button Label', 15, NULL, 'Y', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', 'Villa', '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png'),
(3, 5, 5, 1, 42, 240.00, 'NZD', 'Y', 'Per night', '<ul><li>Triple glazed windows and sound-proof walls</li><li>Keycard entry and locking</li><li>Blinds and shutters</li><li>Desk and chair</li><li>Luggage rack</li><li>Wardrobe</li><li>Wheelchair accessible</li><li>Free wifi</li><li>Free car parking</li><li>Covered outdoor campfire shelter</li><li>BBQ facilities</li></ul>', 'https://www.example.com', 'Find Out More', 16, NULL, 'N', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', 'Room', '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png'),
(4, 4, 4, 1, 42, 347.00, 'NZD', 'Y', 'Per person', '<ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci Eeget Efficitur</li><li>Massa finibus ve</li></ul>', NULL, NULL, 17, NULL, 'N', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', 'Room', '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png'),
(5, 4, 2, NULL, NULL, 350.00, 'NZD', 'Y', 'For 2 people', '<p>Shared facilities with private shower and toilet rooms</p><p>Fully equipped modern kitchen with cookware, coffee, tea, dishes and cutlery</p><p>Beautiful view dining room</p><p>Commercial-grade fridges and freezers</p><p>Cosy lounge area with board games and books&nbsp;</p><p>Storage lockers</p><p>Self-serve on-site laundry and dry room facilities</p><p>Covered outdoor campfire shelter</p><p>BBQ facilities</p><p>On-site dump station and fresh water refill station</p><p>Bicycle rentals</p><p>5-minute walk to Mrs Woolly\'s General Store for groceries, supplies and gifts</p><p>Restaurants, pubs, shops, lagoon walk and the wharf just 5-10 minute walk away</p><p>Track transport easily arranged by Camp Hosts upon request</p><p>Close to Routeburn Track, a wide array of hiking trails, and other stellar track options such as the Rees-Dart Track and Greenstone-Caples Track</p>', NULL, NULL, 43, NULL, 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(6, 5, 5, NULL, NULL, 850.00, 'NZD', 'Y', 'For 2 nights', '<ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', NULL, NULL, 44, NULL, 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(7, 10, 10, NULL, 100, 100.00, 'NZD', 'Y', 'Per Night', '<ul><li>Lorem ipsum</li><li>dolor sit amet</li><li>consectetur adipiscing elit.</li><li>In non tellus ac</li><li>ipsum malesuada scelerisque</li><li>quis vel nisl.</li><li>Ut nec arcu in urna auctor volutpat.</li></ul>', 'https://www.example.com', 'Find out more', 98, '128', 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(8, NULL, NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 100, NULL, 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(9, NULL, NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 101, NULL, 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(10, NULL, NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 102, NULL, 'N', NULL, NULL, NULL, NULL, '', NULL, NULL),
(11, 3, 2, NULL, 42, NULL, NULL, 'N', NULL, '<ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', 'https://www.example.com?yellow-house', NULL, 111, NULL, 'Y', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', NULL, '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png'),
(12, 4, 5, NULL, 42, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 132, NULL, 'N', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', NULL, '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png'),
(13, 5, 10, NULL, 42, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 134, NULL, 'N', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', '<h2>Inclusions</h2><ul><li>Morbi auctor</li><li>Hendrerit tortor sed commodo</li><li>Proin scelerisque</li><li>A quam et convallis</li><li>Mauris a neque</li><li>Justo laoreet tempus</li><li>Donec maximus</li><li>Molestie orci</li><li>Eeget Efficitur</li><li>Massa finibus ve</li></ul>', NULL, '22', '1 Bedroom with Ensuite 1 King Bed and 1 Single Day Bed', 'Sleeps 4 max with rollaway Bed', '/library/images/floor_map.png');
...
(1609, 0x737570706f727440746f6d616861776b2e636f2e6e7a, '', 'Y', '::1', '2026-01-27 05:55:07'),
(1610, 0x737570706f727440746f6d616861776b2e636f2e6e7a, '', 'Y', '::1', '2026-01-28 04:29:56'),
(1611, 0x737570706f727440746f6d616861776b2e636f2e6e7a, '', 'Y', '::1', '2026-01-28 07:42:18');
...
(1, 'Tomahawk', 'Support', '9bc129f7a46381be15f1329c4479e02c70d10d19', 'support@tomahawk.co.nz', '2026-01-28 07:42:18', 1),
...
('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>', 'col-xs-12 col-12 col-sm-6 col-md-6', NULL, 1, 1619),
('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>', 'col-xs-12 col-12 col-sm-6 col-md-6', NULL, 2, 1619),
('<p style=\"text-align:center;\"><a class=\"btn btn-primary\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.booking.com\">Book Now<span contenteditable=\"false\"><svg class=\"btn-arrow-icon\" xmlns=\"http://www.w3.org/2000/svg\" width=\"17.88\" height=\"11.88\" viewBox=\"0 0 29.117 29.117\"><path id=\"arrow_forward_FILL0_wght400_GRAD0_opsz48\" d=\"M174.559,285.117l-1.911-1.956,11.237-11.237H160v-2.73h23.885l-11.237-11.237L174.559,256l14.559,14.559Z\" transform=\"translate(-160 -256)\" fill=\"#fff\"></path></svg></span></a></p>', 'col-xs-12 col-12', NULL, 1, 1620),
...
('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', 'col-xs-12 col-12 col-sm-6 col-md-6', NULL, 1, 1840),
('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', 'col-xs-12 col-12 col-sm-6 col-md-6', NULL, 2, 1840);
...
(43, '/library/images/gallery-image1.jpg', '/library/images/gallery-image1.jpg', 259, 194, 'Enjoy gentle island breezes through screened louvres, revealing panoramic views of verdant foliage and vibrant blooms', '', '', NULL, '7'),
(44, '/library/images/gallery-image2.jpg', '/library/images/gallery-image2.jpg', 1002, 600, 'Enjoy gentle island breezes through screened louvres, revealing panoramic views of verdant foliage and vibrant blooms', '', '', NULL, '7'),
(45, '/library/images/gallery-image3.jpg', '/library/images/gallery-image3.jpg', 1618, 1080, 'Enjoy gentle island breezes through screened louvres, revealing panoramic views of verdant foliage and vibrant blooms', '', '', NULL, '7'),
(46, '/library/images/d.jpg', '/library/images/d.jpg', 1618, 1080, '', '', '', NULL, '7'),
(47, '/library/images/d.jpg', '/library/images/d.jpg', 1620, 1080, '', '', '', NULL, '7'),
(48, '/library/images/d.jpg', '/library/images/d.jpg', 1618, 1080, '', '', '', NULL, '7'),
(50, '/library/images/d.jpg', '/library/images/d.jpg', 1440, 1080, '', '', '', NULL, '7'),
(51, '/library/images/d.jpg', '/library/images/d.jpg', 1618, 1080, '', '', '', NULL, '7'),
(52, '/library/images/d.jpg', '/library/images/d.jpg', 420, 250, '', '', '', NULL, '8'),
(53, '/library/images/d.jpg', '/library/images/d.jpg', 550, 561, '', '', '', NULL, '8'),
...
(480, '/library/images/stay-banner.png', '/uploads/dsc_0288-xdidn.webp', 1626, 1080, '', '', '', '', '', '', NULL, 'H', 3, 41, NULL, NULL, NULL);
...
('page_id', 69, 19, NULL, 0),
('page_id', 69, 12, NULL, 0),
('page_id', 69, 22, NULL, 0);
...
(32, 'Step deeper into the island paradise', '', 3, 69, 'page_id', '', ''),
(33, '', '', 1, 13, 'accommodation_id', '', ''),
(34, '', '', 1, 70, 'page_id', '', '');
...
CREATE TABLE `page_meta_data` (
  ...
  `reservation_banner_rank` varchar(255) DEFAULT NULL,
  `video_id` varchar(20) DEFAULT NULL,
  `video_thumbnail` varchar(255) DEFAULT NULL,
  `video_thumb_thumbnail` varchar(255) DEFAULT NULL,
  `video_file` varchar(255) DEFAULT NULL,
  `video_rank` int(11) NOT NULL DEFAULT 10,
  `faqs_content` text DEFAULT NULL,
  `faqs_heading` varchar(255) DEFAULT NULL,
  `faqs_rank` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(16, 'About -Tile', 'About', 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit.', '/library/images/Highlights/tile-interiors420x250.jpg', '/uploads/tile-interiors420x250-goevs.webp', 'about', 4, NULL, 'Ream more', 'A', NULL),
...
(27, 'Aboutus-Default', 'About', 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', '/library/images/Quicklinks/aboutus-450x550.jpg', '/uploads/aboutus-450x550-39p8q.webp', 'view', 4, NULL, 'Leran more', 'A', NULL),
(28, 'Family', 'Family', NULL, '/library/images/Quicklinks/quicklinks1.jpg', NULL, NULL, NULL, NULL, NULL, 'A', NULL),
(29, 'Experiences', 'Experiences', NULL, '/library/images/Quicklinks/quicklinks2.jpg', NULL, NULL, NULL, NULL, NULL, 'A', NULL),
(30, 'Gallery', 'Gallery', NULL, '/library/images/Quicklinks/quicklinks3.jpg', NULL, NULL, NULL, NULL, NULL, 'A', NULL);
...
--
ALTER TABLE `general_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key for pages', AUTO_INCREMENT=71;
...
--
ALTER TABLE `module_pages`
  MODIFY `modpages_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2194;
