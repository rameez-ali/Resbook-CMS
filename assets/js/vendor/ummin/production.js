...
/*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=f6d441205470f74968ff0419ae02b373)
 * Config saved to config.json and https://gist.github.com/f6d441205470f74968ff0419ae02b373
 */
 ...
 * BSD & MIT license | https://github.com/dbushell/Pikaday
 */
	...
	$.swipebox = function( elem, options ) {
		...
		ui = {
			...
			isVideo : function ( src ) {
				...
				if ( src ) {
					if ( src.match(/mp4|wmv|wma|ogv|ogg|flv/) || src.match( /(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || src.match( /vimeo\.com\/([0-9]*)/ ) || src.match( /youtu\.be\/([a-zA-Z0-9\-_]+)/ ) ) {
						return true;
					}
