...
/** Edit Contact Enquiries - settings */
function editSettings() 
{
  ...
  if (!empty($itemSettings)) {
    ...
    $ceHeading         = $itemSettings['heading'];
    $ceDescription     = $itemSettings['description'];
    $ceFormHeading      = $itemSettings['form_heading'];
    $ceContactEmail    = $itemSettings['contact_email_address'];
    $ceImpPage         = $itemSettings['imp_page'];
  }
  ...
  $arrMenuTabs['Contact Settings']  = $tabModuleSettingsContent;
