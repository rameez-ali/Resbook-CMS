...
function initMain()
{
  ...
  global $do, $id, $message, $itemSelect, $itemRank, 
    $moduleMainHeading, $moduleSubHeading, $modMsgLabel, $listType, $modKey;

  $moduleMainHeading  = 'General Pages';
  $modMsgLabel        = 'General Page';
  $modKey             = 'page_id';
  $moduleContent      = (empty($moduleContent)) ? '' : $moduleContent;
  $template           = (empty($template)) ? '' : $template;
  $moduleActions      = (empty($moduleActions)) ? '' : $moduleActions;
