...
function editSettings()
{
  ...
  if (!empty($itemSettings)) {
    ...
    //$aAccommodationsHeading     = $itemSettings['accommodationcategory_heading'];
    $aButtonText                = $itemSettings['button_text'];
    $aDescription               = $itemSettings['description'];
    $aslideshowSpeed            = $itemSettings['slideshow_speed'];
  } $aallaccomfiltertext        = $itemSettings['allaccomfiltertext'];
  ...
  $arrMenuTabs['Filter Settings']      = $tabModuleFilterSettingsContent;
