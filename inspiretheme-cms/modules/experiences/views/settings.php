...
$tabSettingsContent = '
  <table width="100%" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
      <td>
        <label for="from_price">From Price & Caption:</label>
      </td>
      <td>
        <input type="text" name="from_price" id="from_price" value="'.$itemFromPrice.'"style="width:100px;" 
         maxlength="8"/>
        <input type="text" name="caption" id="caption" value="'.$itemCaption.'"style="width:196px;" 
         maxlength="20"/>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <input type="text" name="currency_code" id="currency_code" value="'.$itemCurrencyCode.'"style="width:150px;" 
         maxlength="15"/>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <input type="text" name="price_description" id="price_description" value="'.$itemPriceDescription.'"style="width:300px;"
        maxlength="45"/>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <input name="button_text" type="text" value="'.$itemButtontext.'" style="width:300px;" id="button_text" 
         maxlength="15">
