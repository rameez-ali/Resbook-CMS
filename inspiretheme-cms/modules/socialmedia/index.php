...
function initMain()
{
  ...
  global $do, $id, $message, $itemSelect, $itemRank, $moduleMainHeading, $moduleSubHeading,$modName, $modMsgLabel, $listType;
  $moduleContent      = (empty($moduleContent)) ? '' : $moduleContent;
  $template           = (empty($template)) ? '' : $template;  
  $moduleMainHeading  = 'Social Media Accounts';
  $modMsgLabel        = 'Social Media Account';
  $modName            = 'Social Media Account';
  ...
  switch ($action) {
    case 'publish':
      $message = ModuleAction::publish($itemSelect,'social_media_account');
      break;

    case 'hide':
      $message = ModuleAction::hide($itemSelect,'social_media_account');
      break;

    case 'delete':
      $message = ModuleAction::delete($itemSelect,'social_media_account');
      break;

    case 'saverank':
      $message = ModuleAction::saveRank($itemRank,'social_media_account');
      break;

    case 'trash': 
      $listType = FLAG_DELETED;
      $message = ($initRestore) ? ModuleAction::restore($itemSelect,'social_media_account') : '';      
      break;
