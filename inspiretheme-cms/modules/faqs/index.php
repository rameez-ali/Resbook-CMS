...
function initMain()
{
  ...
  switch ($action) {
    case 'publish':
      $message = ModuleAction::publish($itemSelect,'faq');
      break;

    case 'hide':
      $message = ModuleAction::hide($itemSelect,'faq');
      break;

    case 'delete':
      $message = ModuleAction::delete($itemSelect,'faq');
      break;

    case 'saverank':
      $message = ModuleAction::saveRank($itemRank,'faq');
      break;

    case 'trash': 
      $listType = FLAG_DELETED;
      $message = ($initRestore) ? ModuleAction::restore($itemSelect,'faq') : '';      
      break;
