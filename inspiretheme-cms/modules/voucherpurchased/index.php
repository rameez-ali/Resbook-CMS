<?php
/**
 * Manage Voucher Purchased Module
 *
 * @category   Module
...
function initMain()
{
  ...
  global $do, $id, $message, $itemSelect, $itemRank, 
    $moduleMainHeading, $moduleSubHeading, $modMsgLabel, $listType, $itemDeliveryString;

  $moduleContent      = (empty($moduleContent)) ? '' : $moduleContent;
  $template           = (empty($template)) ? '' : $template;
  $moduleMainHeading  = 'Voucher Purchased';
  $modMsgLabel        = 'Voucher Purchased';
  ...
  switch ($action) {
    ...
    case 'delete':
      $message = ModuleAction::delete($itemSelect,'voucher_purchased');
      break;
      ...
      <table width="100%" class="bordered">
        <thead>
          <tr>
            ...
            <th width="120">Purchased ID</th>
            <th  width="200">PURCHASER</th>
