...
function editSettings() 
{
  ...
  global $message, $id, $do, $disableMenu, $moduleSubHeading, $moduleMainHeading, $action, $modName;
  $template = '';
  ...
  if (!empty($itemSettings)) {
    ...
    $rsHeading         = $itemSettings['heading'];
    $rsButtonText      = $itemSettings['button_text'];
    $rsBackgroundPhoto = $itemSettings['background_photo'];
    $rsCount           = $itemSettings['limit'];
    $rsOrderBy         = $itemSettings['order_by'];
    $rsSpeed           = $itemSettings['speed'];
    $rsAutoplay        = $itemSettings['autoplay'];
    $rsNavigation      = $itemSettings['navigation'];
    $rsImpPage         = $itemSettings['imp_page'];
  ...
  $arrMenuTabs['Reviews Settings']  = $tabModuleSettingsContent;
