...
$libDirPath = LIBRARY_DIR_PATH.DS;
$ckFinderPath = ADMIN_BASE_PATH.DS.'ckfinder';
...
$config['authentication'] = function () {
    return (!empty($_SESSION['s_user_id']));
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = CKFINDER_LICENSE_NAME;
$config['licenseKey']  = CKFINDER_LICENSE_KEY;
...
$config['privateDir'] = array(
    'backend' => 'default',
    'tags'   => './ckfinder'.DS.'tags',
    'logs'   => './ckfinder'.DS.'logs',
    'cache'  => './ckfinder'.DS.'cache',
    'thumbs' => './ckfinder'.DS.'cache/thumbs',
);
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/'.LIBRARY_DIR.'/',
    'root'         => LIBRARY_DIR_PATH.DS, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => '16M',
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,svg,ico',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => '2M',
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,svg,ico',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
