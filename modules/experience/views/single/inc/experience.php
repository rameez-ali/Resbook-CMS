...
if (!empty($experiences)) {
  ...
  foreach ($experiences AS $experience) {
    ...
    $experiencePriceDescrip     = $experience['price_description'];
    ...
    $experiencePriceDescView .= '<div class="card_pricedesc">'.$experiencePriceDescrip.'</div>';
        ...
        <div class="card__inner">
          <figure class="card__figure">
            ...
            data-category="Experience" data-action="Image Link" data-name="'.$experienceName.'">
              <img src="'.$finalImage.'" alt="'.$experienceAltText.'" class="card__figure-image">
            </a>            
          </figure>
          ...
          <div class="card__cta">
            <a href="'.$experienceUrl.'" class="btn btn--primary card__btn"
             data-category="Experience" data-action="Read More Link" data-name="'.$experienceName.'">
              '.$experienceButtonLabel.' <svg xmlns="http://www.w3.org/2000/svg" width="17.88" height="11.88" viewBox="0 0 29.117 29.117" class="btn-arrow-icon">
  ...
  if (!empty($experienceItem)) {
    ...
    if (!empty($expMoreHeading)) {

      $experienceSectionHeading = '<header class="section__header">
          <h2	class="experience__heading">'.$expMoreHeading.'</h2>
        </header>';
        
    }

    /** Section Header View */
    if (!empty($experienceSectionHeading)) {
    ...
    $templateTags['more_option_view'] .= '<section class="section featured-experience pt-5">
        '.$experienceSectionHeaderView.'
